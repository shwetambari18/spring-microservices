...
public class CurrencyConversionController {
	...
	public CurrencyConversionBean convertCurrency(@PathVariable String from, @PathVariable  String to, @PathVariable  BigDecimal quantity)
	{
		...
		//return new CurrencyConversionBean(1000L,from,to,BigDecimal.TEN,quantity, BigDecimal.TEN.multiply(quantity),80);
	...
	{
		CurrencyConversionBean response = currencyExchangeProxy.retrieveExchangeValueUsingFeign(from, to);
